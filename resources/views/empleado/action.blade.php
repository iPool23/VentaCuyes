<div class="modal-content">
    ...
    <form id="empleadoForm"
        action="{{ isset($empleado->id) ? route('empleado.update', $empleado->id) : route('empleado.store') }}"
            ...
            <div class="row">
                <div class="row mb-4">
                    <div class="col-md-12 text-center">
                        @if (isset($empleado) && $empleado->imagen_perfil)
                            <img id="preview" src="{{ asset('empleados/' . $empleado->imagen_perfil) }}"
                                class="rounded-circle border shadow-sm"
                                style="width: 120px; height: 120px; object-fit: cover;">
                        @else
                            <img id="preview" src="{{ asset('perfiles/user-avatar.png') }}"
                                class="rounded-circle border shadow-sm"
                                style="width: 120px; height: 120px; object-fit: cover;">
                        @endif
